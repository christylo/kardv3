...
import { View, Image, SafeAreaView, Text, StyleSheet, TouchableOpacity, Button, ActivityIndicator, Clipboard, FlatList, Share, ScrollView } from 'react-native';
...
export default class TakeAPicture extends React.Component {
    state = {
        image: null,
        uploading: false,
        googleResponse: null
    ...
    submitToGoogle = async () => {
        try {
            ...
            let response = await fetch(
                ...
                'AIzaSyA1g9kxGZkDGMYOiQuUlvvjrxr5-_Qeq70',
                {
                    headers: {
